...
public class Moves {
    ...
    public static String posibleMovesW(String history, long WP, long WN, long WB, long WR, long WQ, long WK, long BP,
    ...
    public static String posiblePW(String history, long WP) {
        ...
        for (int i = Long.numberOfTrailingZeros(PAWN_MOVES); i < 64 - Long.numberOfLeadingZeros(PAWN_MOVES); i++) {
            if (((PAWN_MOVES >> i) & 1) == 1) {
                list += "" + (i % 8 - 1) + (i % 8) + "QP" + (i % 8 - 1) + (i % 8) + "RP" + (i % 8 - 1) + (i % 8) + "BP"
                        + (i % 8 - 1) + (i % 8) + "NP";
            }
        }
        ...
        for (int i = Long.numberOfTrailingZeros(PAWN_MOVES); i < 64 - Long.numberOfLeadingZeros(PAWN_MOVES); i++) {
            if (((PAWN_MOVES >> i) & 1) == 1) {
                list += "" + (i % 8) + (i % 8) + "QP" + (i % 8) + (i % 8) + "RP" + (i % 8) + (i % 8) + "BP" + (i % 8)
                        + (i % 8) + "NP";
            }
        }
        // y1,y2,Space,"E
